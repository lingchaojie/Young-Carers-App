...
public class staffContact6 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_staff_contact6);
        ...
        name.setText("Lisa Watson");
        job.setText("0-25 Carer Services Manager");
        email.setText("lisaw@sunderlandcarers.co.uk");
    }
}
