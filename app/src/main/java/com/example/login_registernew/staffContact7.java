...
public class staffContact7 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_staff_contact7);
        ...
        name.setText("Sue Callaghan");
        job.setText("Carer Practitioner Activity Lead");
        email.setText("sue@sunderlandcarers.co.uk");
    }
}
