...
public class staffContact5 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_staff_contact5);
        ...
        name.setText("Jenna Robson");
        job.setText("0-25 Carer Activity Facilitator");
        email.setText("jenna@sunderlandcarers.co.uk");
    }
}
