...
public class staffContact4 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_staff_contact4);
        ...
        name.setText("Graeme Flaxen");
        job.setText("Independent Support Carer Practitioner ");
        email.setText("graeme@sunderlandcarers.co.uk");
    }
}
