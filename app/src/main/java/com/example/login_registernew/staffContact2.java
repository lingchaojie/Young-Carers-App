...
public class staffContact2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_staff_contact2);
        ...
        name.setText("Amy Howard");
        job.setText("Independent Support Carer Practitioner");
        email.setText("amy@sunderlandcarers.co.uk");
    }
